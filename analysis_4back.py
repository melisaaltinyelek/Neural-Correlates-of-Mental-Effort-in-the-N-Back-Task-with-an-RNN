...
if __name__ == "__main__":
    ...
    test_acc_wo_lures, pred_responses = rnn_model.eval_model_without_lures(X_test_4back_wo_lures, y_test_4back_wo_lures)
    rnn_model.visualize_preds_without_lures(y_test_4back_wo_lures, pred_responses)
    
    test_acc_w_lures, pred_responses_w_lures = rnn_model.eval_model_with_lures(X_test_4back_w_lures, y_test_4back_w_lures)
    rnn_model.visualize_preds_with_lures(y_test_4back_w_lures, pred_responses_w_lures)
